...
public class ClientEventHandler {
    ...
    static void handlePayload(QuickTriggerPayloads.HomeLimitPayload payload) {
    ...
    public void onLogIn(ClientPlayerNetworkEvent.LoggingIn event) {
        ...
        if (data != null && data.ip != null && !data.ip.isBlank()) {
            ...
            ClientState.currentServerKey = data.ip;
        } else {
            try {
                if (client.getSingleplayerServer() != null) {
                    ...
                    if (name != null && !name.isBlank()) {
                        ...
                        ClientState.currentServerKey = "local:" + name;
                    } else {
                        ClientState.currentServerKey = "local";
                    }
                } else {
                    ClientState.currentServerKey = "local";
                }
    ...
    public void onScreenInit(ScreenEvent.Init.Post event) {
        ...
        event.addListener(new ItemButton(
            bgX + 7, bgY - 20,
