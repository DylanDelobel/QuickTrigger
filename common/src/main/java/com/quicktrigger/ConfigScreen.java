...
public class ConfigScreen extends Screen {
    ...
    public ConfigScreen(Screen parent) {
        ...
        String serverKey = ClientState.currentServerKey != null ? ClientState.currentServerKey : "offline";
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(
            ...
            btn -> {
                ...
                String key = ClientState.currentServerKey != null ? ClientState.currentServerKey : "offline";
